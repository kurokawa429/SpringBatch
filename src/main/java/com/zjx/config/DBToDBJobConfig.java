...
import com.zjx.job.partitioner.DBToDBPartitioner;
...
public class DBToDBJobConfig {
    ...
    public MyBatisPagingItemReader<Employee> dBToDBJobItemReader(
        ...
        itemReader.setQueryId("com.zjx.mapper.EmployeeMapper.selectTempForList");
    ...
    public MyBatisBatchItemWriter<Employee> dbToDBItemWriter(){
        ...
        itemWriter.setStatementId("com.zjx.mapper.EmployeeMapper.save");  //操作sql
        return itemWriter;
    }
